...
import { generatePlantReport } from "../services/report.service.js";
...
export async function reportRoutes(fastify) {
     ...
     */
    fastify.post("/report", { preHandler: fastify.authenticate }, async (request, reply) => {
     ...
     */
    fastify.get("/report/history", { preHandler: fastify.authenticate }, async (request, reply) => {
        const userId = request.user.sub;
